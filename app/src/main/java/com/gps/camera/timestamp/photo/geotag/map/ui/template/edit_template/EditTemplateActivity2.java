...
public class EditTemplateActivity2 extends BaseActivity<ActivityEditTemplateBinding> {
    ...
    public void initView() {
        ...
        binding.txtTitleTemplate.setText(getString(R.string.Template2_new));
    ...
    private String positionStrText = "Top";
    private int positionStr = 1;
    private String Str = "01";
    public void listener() {
        binding.btnBack.setOnClickListener(v -> {
            HelperClass.hideSoftKeyboard(EditTemplateActivity2.this, v);
            Intent intent = new Intent();
        ...
        binding.btnSave.setOnClickListener(v -> {
            mSP.setString(EditTemplateActivity2.this, "pos_type_temp2", positionStrText);
            util.SavePreferences("positionX2", String.valueOf(positionStr));
            if (istimezone){
                SavePreferences("timezone_Temp2", "Yes");
            }else {
                SavePreferences("timezone_Temp2", "No");
            }
            if (isDateTime){
                SavePreferences("DateTime_Temp2", "Yes");
            }else {
                SavePreferences("DateTime_Temp2", "No");
            }
            if (isAddress){
                SavePreferences("Address_Temp2", "Yes");
            }else {
                SavePreferences("Address_Temp2", "No");
            }
            if (isLatLng){
                SavePreferences("laglog_Temp2", "Yes");
            }else {
                SavePreferences("laglog_Temp2", "No");
            }
            if (islogo){
                SavePreferences("logo_Temp2", "Yes");
            }else {
                SavePreferences("logo_Temp2", "No");
            }
            if (isMagneticField){
                SavePreferences("magnetic_Temp2", "Yes");
            }else {
                SavePreferences("magnetic_Temp2", "No");
            }
            if (isCompass){
                SavePreferences("compass_Temp2", "Yes");
            }else {
                SavePreferences("compass_Temp2", "No");
            }
            if (isnotes){
                SavePreferences("hashtag_Temp2", "Yes");
            }else {
                SavePreferences("hashtag_Temp2", "No");
            }
            if (isNumbering){
                SavePreferences("number_Temp2", "Yes");
            }else {
                SavePreferences("number_Temp2", "No");
            }
    ...
    private void init() {
        ...
        positionStrText = mSP.getString(EditTemplateActivity2.this, "pos_type_temp2", "Top");;

        binding.txtTitleTemplate.setText(getString(R.string.Template2_new));
        setNotes();
        this.DateTime = showPreferences("DateTime_Temp2");
        this.Address = showPreferences("Address_Temp2");
        this.lagitud = showPreferences("laglog_Temp2");
        this.Timezone = showPreferences("timezone_Temp2");
        this.Logo = showPreferences("logo_Temp2");
        this.humidity = showPreferences("humidity_Temp2");
        this.presurre = showPreferences("pressure_Temp2");
        this.magnetic = showPreferences("magnetic_Temp2");
        this.compass = showPreferences("compass_Temp2");
        this.note = showPreferences("hashtag_Temp2");
        this.numbering = showPreferences("number_Temp2");
