...
public interface AVKey {
    ...
    String CAPABILITIES_TEMPLATE_PATH = "gov.nasa.worldwind.avkey.CapabilitiesTemplatePath";
    ...
    String DATABASE_CONNECTION_POOL_CLASS_NAME = "gov.nasa.worldwind.avkey.Database.ConnectionPoolClassName";
    String DATABASE_CONNECTION_POOL_FACTORY_CLASS_NAME = "gov.nasa.worldwind.avkey.Database.ConnectionPoolFactoryClassName";
    String DATABASE_CONNECTION_STRING = "gov.nasa.worldwind.avkey.Database.ConnectionString";
    String DATABASE_DRIVER_CLASS_NAME = "gov.nasa.worldwind.avkey.Database.DriverClassName";
    String DATABASE_PASSWORD = "gov.nasa.worldwind.avkey.Database.Password";
    String DATABASE_POLICY_INITIAL_CONNECTIONS = "gov.nasa.worldwind.avkey.DatabasePolicy.InitialConnections";
    String DATABASE_POLICY_MAXIMUM_CONNECTIONS = "gov.nasa.worldwind.avkey.DatabasePolicy.MaximumConnections";
    String DATABASE_POLICY_WAIT_IF_BUSY = "gov.nasa.worldwind.avkey.DatabasePolicy.WaitIfBusy";
    String DATABASE_USERNAME = "gov.nasa.worldwind.avkey.Database.Username";
    ...
    String DATA_FILE_STORE_CONFIGURATION_FILE_NAME = "gov.nasa.worldwind.avkey.DataFileStoreConfigurationFileName";
    ...
    String HTTP_FILE_UPLOAD_AUTH_TOKEN = "gov.nasa.worldwind.avkey.HTTP.FileUpload.AuthToken";
    String HTTP_FILE_UPLOAD_LOCATION = "gov.nasa.worldwind.avkey.HTTP.FileUpload.TempLocation";
    String HTTP_FILE_UPLOAD_TEMP_LOCATION = "gov.nasa.worldwind.avkey.HTTP.FileUpload.TempLocation";
    String HTTP_SERVER_ALLOW_FILE_UPLOAD = "gov.nasa.worldwind.avkey.HTTP.Server.Allow.FileUpload";
    String HTTP_SERVER_ALLOW_GET = "gov.nasa.worldwind.avkey.HTTP.Server.Allow.GET";
    String HTTP_SERVER_ALLOW_POST = "gov.nasa.worldwind.avkey.HTTP.Server.Allow.POST";
    String HTTP_SERVER_FILE_UPLOAD_MAX_SIZE = "gov.nasa.worldwind.avkey.HTTP.Server.FileUpload.MaxSize";
    ...
    String KEYSTORE_PASSWORD = "gov.nasa.worldwind.avkey.KeystorePassword";
    String KEYSTORE_PATH = "gov.nasa.worldwind.avkey.KeystorePath";
    String KEYSTORE_USER = "gov.nasa.worldwind.avkey.KeystoreUser";
